...
@section('content')
    <div class="max-w-xl mx-auto">
        <h1 class="text-2xl font-bold mb-6">إضافة نوع جديد</h1>
        <p class="mb-4 text-sm text-slate-500">
            أنت تضيف نوعًا (مثل تحيات أو أرقام) داخل المستوى:
        ...
        <form method="POST" action="{{ route('decks.store') }}" class="bg-white rounded-xl border border-slate-200 p-6">
            ...
            <div class="mt-6 flex items-center justify-end gap-2">
                ...
                <button type="submit" class="px-4 py-2 rounded-md bg-indigo-600 text-white hover:bg-indigo-700 text-sm font-medium">حفظ النوع</button>
            </div>
        </form>
    </div>
@endsection
